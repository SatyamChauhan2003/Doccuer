                  ...
                  <div className="account-content">
                    <div className="row align-items-center justify-content-center">
                      <div className="col-md-7 col-lg-6 login-left">
                        <img
                          src="/pharmacy_assets/img/login-banner.png"
                          className="img-fluid"
                      ...
                      <div className="col-md-12 col-lg-6 login-right">
                        ...
                        <form action="https://doccure.dreamguystech.com/html/template/pharmacy-register-step1">
                            ...
                            <div className="footer-address mb-0">
                              <p>
                                ...
                                <a
                                  ...
                                  data-cfemail="bbdfd4d8d8cec9defbdec3dad6cbd7de95d8d4d6"
                                >
                                  [email&#160;protected]
                                </a>
                              </p>
...
export default Pharmacy_register;
