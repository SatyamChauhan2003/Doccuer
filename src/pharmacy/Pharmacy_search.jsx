            ...
            <nav className="navbar navbar-expand-lg header-nav">
              <div className="navbar-header">
                ...
                <a href="index-2" className="navbar-brand logo">
                  <img src="/pharmacy_assets/img/logo.png" className="img-fluid" alt="Logo" />
                </a>
              </div>
              <div className="main-menu-wrapper">
                <div className="menu-header">
                  <a href="index-2" className="menu-logo">
                    <img
                      src="/pharmacy_assets/img/logo.png"
                      className="img-fluid"
                      alt="Logo"
                    />
                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-2" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-11.jpg"
                                      className="img-fluid "
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo ">
                                <div className="demo-img">
                                  <a href="index-3" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-10.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-4" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-09.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-5" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-08.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-6" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-07.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-7" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-06.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-8" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-05.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-9" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-04.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-10" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-03.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-11" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-02.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                              ...
                              <div className="single-demo">
                                <div className="demo-img">
                                  <a href="index-12" className="inner-demo-img">
                                    <img
                                      src="/pharmacy_assets/img/home-01.jpg"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </a>
                      ...
                      <ul className="shopping-cart-items list-unstyled">
                        <li className="clearfix">
                          ...
                          <a href="product-description">
                            <img
                              ...
                              src="/pharmacy_assets/img/products/product.jpg"
                              alt="User Image"
                            />
                          </a>
                        ...
                        <li className="clearfix">
                          ...
                          <a href="product-description">
                            <img
                              className="avatar-img rounded"
                              src="/pharmacy_assets/img/products/product1.jpg"
                              alt="User Image"
                            />
                          </a>
                          <a href="product-description" className="item-name">
                        ...
                        <li className="clearfix">
                          ...
                          <a href="product-description">
                            <img
                              className="avatar-img rounded"
                              src="/pharmacy_assets/img/products/product2.jpg"
                              alt="User Image"
                            />
                          </a>
                          <a href="product-description" className="item-name">
                            ...
                            <div className="notify-block d-flex">
                              <span className="avatar">
                                <img
                                  ...
                                  alt="Ruby perin"
                                  src="/pharmacy_assets/img/clients/client-01.jpg"
                                />
                              </span>
                            ...
                            <div className="notify-block d-flex">
                              <span className="avatar">
                                <img
                                  className="avatar-img"
                                  alt="Hendry Watt"
                                  src="/pharmacy_assets/img/clients/client-02.jpg"
                                />
                              </span>
                              <div className="media-body">
                                <h6>
                            ...
                            <div className="notify-block d-flex">
                              <div className="avatar">
                                <img
                                  className="avatar-img"
                                  alt="Maria Dyen"
                                  src="/pharmacy_assets/img/clients/client-03.jpg"
                                />
                              </div>
                              <div className="media-body">
                                <h6>
                            ...
                            <div className="notify-block d-flex">
                              <div className="avatar avatar-sm">
                                <img
                                  className="avatar-img"
                                  alt="client-image"
                                  src="/pharmacy_assets/img/clients/client-04.jpg"
                                />
                              </div>
                              <div className="media-body">
                                <h6>
                  ...
                  >
                    <span className="user-img">
                      <img
                        ...
                        src="/pharmacy_assets/img/patients/patient.jpg"
                        width="31"
                        alt="Darren Elder"
                      />
                    </span>
            ...
            <div className="row">
              ...
              <div className="col-md-12 col-lg-8 col-xl-9">
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        <div className="doctor-img1">
                          <a href="pharmacy-details">
                            <img
                              src="/pharmacy_assets/img/medical-img1.jpg"
                              className="img-fluid"
                              alt="User Image"
                            />
                          </a>
                        ...
                        <div className="doc-info-cont">
                          <h4 className="doc-name mb-2">
                            <a href="pharmacy-details">Medlife Medical</a>
                          </h4>
                          ...
                          <div className="clinic-details">
                            <div className="clini-infos pt-3">
                              ...
                              <p className="doc-location mb-2 text-ellipse">
                                <i className="fas fa-map-marker-alt me-1"></i> 96
                              ...
                              <p className="doc-location mb-2">
                                <i className="fas fa-chevron-right me-1"></i> Opens
                                at 08.00 AM
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="doc-info-right">
                        <div className="clinic-booking">
                          <a className="view-pro-btn" href="pharmacy-details">
                            View Details
                          </a>
                          <a className="apt-btn" href="product-all">
                            Browse Products
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        <div className="doctor-img1">
                          <a href="pharmacy-details">
                            <img
                              src="/pharmacy_assets/img/medical-img2.jpg"
                              className="img-fluid"
                              alt="User Image"
                            />
                          </a>
                        ...
                        <div className="doc-info-cont">
                          <h4 className="doc-name mb-2">
                            <a href="pharmacy-details">PharmaMed Medical</a>
                          </h4>
                          <div className="rating mb-2">
                            <span className="badge badge-primary">4.0</span>
                            <i className="fas fa-star filled"></i>
                          ...
                          <div className="clinic-details">
                            <div className="clini-infos pt-3">
                              ...
                              <p className="doc-location mb-2 text-ellipse">
                                <i className="fas fa-map-marker-alt me-1"></i> 3830
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        <div className="doctor-img1">
                          <a href="pharmacy-details">
                            <img
                              src="/pharmacy_assets/img/medical-img3.jpg"
                              className="img-fluid"
                              alt="User Image"
                            />
                          </a>
                        ...
                        <div className="doc-info-cont">
                          ...
                          <div className="clinic-details">
                            <div className="clini-infos pt-3">
                              ...
                              <p className="doc-location mb-2 text-ellipse">
                                <i className="fas fa-map-marker-alt me-1"></i> 3849
                ...
                <div className="load-more text-center">
                  <a className="btn btn-primary btn-md" href="javascript:void(0);">
                    Load More
                  </a>
                </div>
              </div>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="b9ddd6dadacccbdcf9dcc1d8d4c9d5dc97dad6d4"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
...
export default Pharmacy_search;
