                            ...
                            <h2 className="table-avatar">
                              <span className="avatar avatar-sm me-2">
                                <img
                                  ...
                                  src="/pharmacy_assets/img/product/product10.jpg"
                                  alt="product image"
                                />
                              </span>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              <span className="avatar avatar-sm me-2">
                                <img
                                  className="avatar-img"
                                  src="/pharmacy_assets/img/product/product11.jpg"
                                  alt="product image"
                                />
                              </span>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              <span className="avatar avatar-sm me-2">
                                <img
                                  className="avatar-img"
                                  src="/pharmacy_assets/img/product/product12.jpg"
                                  alt="product image"
                                />
                              </span>
                              Acetrace Amionel
                          ...
                          <td>
                            <h2 className="table-avatar">
                              <span className="avatar avatar-sm me-2">
                                <img
                                  className="avatar-img"
                                  src="/pharmacy_assets/img/product/product13.jpg"
                                  alt="product image"
                                />
                              </span>
                              Rapalac Neuronium
                          ...
                          <td>
                            <h2 className="table-avatar">
                              <span className="avatar avatar-sm me-2">
                                <img
                                  className="avatar-img"
                                  src="/pharmacy_assets/img/product/product14.jpg"
                                  alt="product image"
                                />
                              </span>
