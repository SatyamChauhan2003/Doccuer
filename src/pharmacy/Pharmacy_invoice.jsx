        ...
        <div className="content container-fluid">
          <div className="invoice-container">
            ...
            <div className="row">
                  ...
                  <li>
                    <a href="#">
                      <span
                        ...
                        data-cfemail="1f7c777e6d737a717a6d7a7a7b5f7a677e726f737a317c7072"
                      >
                        [email&#160;protected]
                      </span>
                    </a>
              ...
              <div className="col-sm-6 col-lg-5 col-xl-4 m-b-20 mb-5">
                    ...
                    <div className="table-responsive no-border">
                      <table className="table mb-0">
                        <tbody>
                          <tr>
                            <th>Subtotal:</th>
                            <td className="text-center table-space">$250</td>
                          </tr>
                          <tr>
                            <th>
                              Tax: <span className="text-regular">(25%)</span>
                            </th>
                            <td className="text-center table-space">$50</td>
                          </tr>
                          <tr>
                            <th>Total:</th>
...
export default Pharmacy_invoice;
