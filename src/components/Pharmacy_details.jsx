                ...
                <div className="doctor-widget">
                  <div className="doc-info-left">
                    <div className="doctor-img1">
                      <a href="pharmacy-details">
                        <img
                          src="/component_assets/img/medical-img1.jpg"
                          className="img-fluid"
                          alt="User Image"
                        />
                      </a>
                      ...
                      <div className="clinic-details">
                        <div className="clini-infos pt-3">
                          ...
                          <p className="doc-location mb-2 text-ellipse">
                            <i className="fas fa-map-marker-alt me-1"></i> 96 Red
                            Hawk Road Cyrus, MN 56323{" "}
                          </p>
                          <p className="doc-location mb-2">
                            <i className="fas fa-chevron-right me-1"></i> Chemists,
                            Surgical Equipment Dealer
                          </p>
                          <p className="doc-location mb-2">
                            <i className="fas fa-chevron-right me-1"></i> Opens at
                            08.00 AM
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="doc-info-right d-flex align-items-center justify-content-center">
                    <div className="clinic-booking">
                      <a className="view-pro-btn" href="chat">
                        Send Message
                      </a>
                      <a
                        className="apt-btn"
                      ...
                      <a href="product-all" className="view-pro-btn">
                        Browse Products
                      </a>
                    </div>
                  </div>
                      ...
                      <div className="clinic-content">
                        ...
                        <div className="clinic-details mb-0">
                          <h5 className="clinic-direction">
                            {" "}
                            <i className="fas fa-map-marker-alt"></i> 96 Red Hawk
                            Road Cyrus, MN 56323 <br />
                      ...
                      <div className="clinic-content">
                        ...
                        <div className="clinic-details mb-0">
                          <p className="clinic-direction">
                            {" "}
                            <i className="fas fa-map-marker-alt"></i> 310 Cambridge
                        ...
                        <div className="footer-address mb-0">
                          <p>
                            ...
                            <a
                              ...
                              data-cfemail="fc98939f9f898e99bc99849d918c9099d29f9391"
                            >
                              [email&#160;protected]
                            </a>
                          </p>
                ...
                <div className="call-wrapper">
                  <div className="call-inner">
                    ...
                    <div className="call-items">
                      ...
                      <a href="voice-call" className="btn call-item call-start">
                ...
                <div className="call-wrapper">
                  <div className="call-inner">
                    ...
                    <div className="call-items">
                      ...
                      <a href="video-call" className="btn call-item call-start">
