              ...
              <div className="col-md-12">
                <div className="terms-content">
                  ...
                  <div className="terms-text terms-list">
                    <p>
                      <i className="fas fa-circle-check"></i> At vero eos et
                      accusamus et iusto odio dignissimos ducimus qui blanditiis
                      praesentium voluptatum deleniti atque corrupti quos
                      dolores et
                    </p>
                    <p>
                      <i className="fas fa-circle-check"></i> Sed ut perspiciatis
                      unde omnis iste natus error sit voluptatem accusantium
                      doloremque laudantium,
                    </p>
                    <p>
                      <i className="fas fa-circle-check"></i> Nemo enim ipsam
                ...
                <div className="terms-btn">
                  <a href="javascript:void(0);" className="btn btn-right-now">
                    Not right now...
                  </a>
                  <a
                    href="javascript:void(0);"
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="24404b474751564164415c45495448410a474b49"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
