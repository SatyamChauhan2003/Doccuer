                        ...
                        <div className="widget-content multistep-form">
                          <fieldset id="first">
                                ...
                                <li className="progress-active">
                                  <div className="step-box">
                                    <div className="step-icon">
                                      <span>
                                        <img
                                          src="/component_assets/img/icons/signup-users.svg"
                                          alt="icon"
                                        />
                                      </span>
                                    </div>
                                ...
                                <li>
                                  <div className="step-box">
                                    <div className="step-icon">
                                      <span>
                                        <img
                                          src="/component_assets/img/icons/signup-unlock.svg"
                                          alt="icon"
                                        />
                                      </span>
                                    </div>
                            ...
                            <div className="widget-btn">
                              <a className="btn btn-primary w-100 next_btn">Next</a>
                            </div>
                          </fieldset>
                          <fieldset className="field-card">
                            ...
                            <form
                              action="https://doccure.dreamguystech.com/html/template/signup-success"
