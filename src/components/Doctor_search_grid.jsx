                      ...
                      <div className="filter-details">
                        ...
                        <div className="filter-grid">
                          ...
                          <div id="collapsefour" className="collapse show">
                            <div className="filter-collapse">
                              <ul className="fill-more" id="fill-more">
                                <li>
                                  <label className="custom_check d-inline-flex">
                        ...
                        <div className="filter-grid">
                          ...
                          <div id="collapsefive" className=" collapse show">
                            <div className="filter-collapse">
                              <ul className="fill-more" id="fill-more1">
                                <li>
                                  <label className="custom_check d-inline-flex">
                        ...
                        <div className="filter-grid">
                          ...
                          <div id="collapsesix" className="collapse show">
                            <div className="filter-collapse">
                              <ul className="fill-more" id="fill-more2">
                                <li>
                                  <label className="custom_check d-inline-flex">
                        ...
                        <div className="doctor-filter-option">
                          ...
                          <div className="doctor-filter-sort">
                            <p className="filter-today d-flex align-items-center">
                              <i className="feather-calendar"></i> Today 10 Aug to
                              20 Aug
                            </p>
                          </div>
                          <div className="doctor-filter-sort">
                            <ul className="nav">
                              ...
                              <li>
                                <a href="doctor-search-grid" className="active">
                          ...
                          <div className="doc-content">
                            <div className="doc-pro-info">
                              ...
                              <div className="review-price">
                                <p>
                                  $1100.00<span>/hr</span>
                                </p>
                              </div>
                            </div>
                            <div className="doc-pro-location">
                              <p>
                                <i className="feather-map-pin"></i> <span>0.9</span>{" "}
                                mi - New York, USA
                              </p>
                              <p>
                                <i className="feather-award"></i> <span>15</span>{" "}
                                Years of Experience
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="doctor-profile-widget doc-grid">
                          <div className="doc-pro-img">
                            <a href="doctor-profile">
                              <div className="doctor-profile-img">
                                <img
                                  src="/component_assets/img/doctors/doctor-14.jpg"
                                  className="img-fluid"
                                  alt="Darren Elder"
                                />
                              </div>
                          ...
                          <div className="doc-content">
                            ...
                            <div className="doc-pro-location">
                              ...
                              <p>
                                <i className="feather-award"></i> <span>12</span>{" "}
                        ...
                        <div className="doctor-profile-widget doc-grid">
                          <div className="doc-pro-img">
                            <a href="doctor-profile">
                              <div className="doctor-profile-img">
                                <img
                                  src="/component_assets/img/doctors/doctor-15.jpg"
                                  className="img-fluid"
                                  alt="Sofia Brient"
                                />
                              </div>
                          ...
                          <div className="doc-content">
                            ...
                            <div className="doc-pro-location">
                              ...
                              <p>
                                <i className="feather-award"></i> <span>20</span>{" "}
                                Years of ExperienceA
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="doctor-profile-widget doc-grid">
                          <div className="doc-pro-img">
                            <a href="doctor-profile">
                              <div className="doctor-profile-img">
                                <img
                                  src="/component_assets/img/doctors/doctor-16.jpg"
                                  className="img-fluid"
                                  alt="Johny Rita"
                                />
                              </div>
                          ...
                          <div className="doc-content">
                            ...
                            <div className="doc-pro-location">
                              ...
                              <p>
                                <i className="feather-award"></i> <span>8</span>{" "}
                                Years of ExperienceA
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="doctor-profile-widget doc-grid">
                          <div className="doc-pro-img">
                            <a href="doctor-profile">
                              <div className="doctor-profile-img">
                                <img
                                  src="/component_assets/img/doctors/doctor-17.jpg"
                                  className="img-fluid"
                                  alt="Deborah Angel"
                                />
                              </div>
                        ...
                        <div className="doctor-profile-widget doc-grid">
                          <div className="doc-pro-img">
                            <a href="doctor-profile">
                              <div className="doctor-profile-img">
                                <img
                                  src="/component_assets/img/doctors/doctor-18.jpg"
                                  className="img-fluid"
                                  alt="Ruby Perrin"
                                />
                              </div>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="4c28232f2f393e290c29342d213c2029622f2321"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
...
export default Doctor_search_grid;
