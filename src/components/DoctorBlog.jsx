                    ...
                    <div className="col">
                      <ul className="nav nav-tabs nav-tabs-solid">
                        <li className="nav-item">
                          <a className="nav-link active" href="doctor-blog">
                            Acitive Blog
                          </a>
                        </li>
                        <li className="nav-item">
                          <a className="nav-link" href="doctor-pending-blog">
                            Pending Blog
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="col-md-6 col-xl-4 col-sm-12">
                      <div className="blog grid-blog">
                        ...
                        <div className="row pt-3">
                          <div className="col">
                            <a href="edit-blog" className="text-success">
                          ...
                          <div className="col text-end">
                            ...
                            >
                              <i className="far fa-trash-alt"></i> Inactive
                            </a>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="90f4fff3f3e5e2f5d0f5e8f1fde0fcf5bef3fffd"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
