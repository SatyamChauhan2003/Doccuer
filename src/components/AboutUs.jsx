                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="about-inner-img">
                      <div className="about-img">
                        <img
                          src="/component_assets/img/about-img1.jpg"
                          className="img-fluid"
                          alt="about-image"
                        />
                      </div>
                      <div className="about-img">
                        <img
                          src="/component_assets/img/about-img2.jpg"
                          className="img-fluid"
                          alt="about-image"
                        />
                      </div>
                  ...
                  <div className="col-md-6">
                    <div className="about-inner-img">
                      ...
                      <div className="about-img">
                        <img
                          src="/component_assets/img/about-img3.jpg"
                          className="img-fluid"
                          alt="about-image"
                        />
                      </div>
              ...
              <div className="about-content">
                ...
                <div className="about-contact">
                  <div className="about-contact-icon">
                    <span>
                      <img
                        src="/component_assets/img/icons/phone-icon.svg"
                        alt="phone-image"
                      />
                    </span>
                  </div>
              ...
              <div className="card why-choose-card w-100">
                <div className="card-body">
                  <div className="why-choose-icon">
                    <span>
                      <img
                        src="/component_assets/img/icons/choose-01.svg"
                        alt="choose-image"
                      />
                    </span>
                  </div>
              ...
              <div className="card why-choose-card w-100">
                <div className="card-body">
                  <div className="why-choose-icon">
                    <span>
                      <img
                        src="/component_assets/img/icons/choose-02.svg"
                        alt="choose-image"
                      />
                    </span>
                  </div>
              ...
              <div className="card why-choose-card w-100">
                <div className="card-body">
                  <div className="why-choose-icon">
                    <span>
                      <img
                        src="/component_assets/img/icons/choose-03.svg"
                        alt="choose-image"
                      />
                    </span>
                  </div>
              ...
              <div className="card why-choose-card w-100">
                <div className="card-body">
                  <div className="why-choose-icon">
                    <span>
                      <img
                        src="/component_assets/img/icons/choose-04.svg"
                        alt="choose-image"
                      />
                    </span>
                  </div>
          ...
          <div className="way-bg">
            <div className="way-shapes-img">
              <div className="way-shapes-left">
                <img src="/component_assets/img/shape-06.png" alt="shape-image" />
              </div>
              <div className="way-shapes-right">
                <img src="/component_assets/img/shape-07.png" alt="shape-image" />
              </div>
            </div>
            <div className="row align-items-end">
              ...
              <div className="col-lg-5 col-md-12">
                <div className="way-img">
                  <img
                    src="/component_assets/img/way-img.png"
                    className="img-fluid"
                ...
                <div className="doc-pro-img">
                  <Link to="/doctor-profile">
                    <div className="doctor-profile-img">
                      <img
                        src="/component_assets/img/doctors/doctor-03.jpg"
                        className="img-fluid"
                        alt="Ruby Perrin"
                      />
                    </div>
              ...
              <div className="doctor-profile-widget w-100">
                <div className="doc-pro-img">
                  <Link to="doctor-profile">
                    <div className="doctor-profile-img">
                      <img
                        src="/component_assets/img/doctors/doctor-04.jpg"
                        className="img-fluid"
                        alt="Darren Elder"
                      />
                    </div>
              ...
              <div className="doctor-profile-widget w-100">
                <div className="doc-pro-img">
                  <Link to="doctor-profile">
                    <div className="doctor-profile-img">
                      <img
                        src="/component_assets/img/doctors/doctor-05.jpg"
                        className="img-fluid"
                        alt="Sofia Brient"
                      />
                    </div>
      ...
      <section className="testimonial-section">
        <div className="testimonial-shape-img">
          <div className="testimonial-shape-left">
            <img src="/component_assets/img/shape-04.png" alt="shape-image" />
          </div>
          <div className="testimonial-shape-right">
            <img src="/component_assets/img/shape-05.png" alt="shape-image" />
          </div>
        </div>
        <div className="container">
          <div className="row">
              ...
              <div className="testimonial-slider slick">
                ...
                <div className="testimonial-grid">
                  <div className="testimonial-info">
                    <div className="testimonial-img">
                      <img
                        src="/component_assets/img/clients/client-05.jpg"
                        className="img-fluid"
                        alt="client-image"
                      />
                    </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="faq-img">
                <img src="/component_assets/img/faq-img.png" className="img-fluid" alt="img" />
                <div className="faq-patients-count">
                  <div className="faq-smile-img">
                    <img src="/component_assets/img/icons/smiling-icon.svg" alt="icon" />
                  </div>
