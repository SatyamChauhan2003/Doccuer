            ...
            <div className="row">
              ...
              <div className="col-md-7 col-lg-9 col-xl-9">
                <div className="row align-items-center pb-3">
                  <div className="col-md-4 col-12 d-md-block d-none custom-short-by">
                    ...
                    <p className="doc-location mb-2 text-ellipse pharmacy-location">
                      <i className="fas fa-map-marker-alt me-1"></i> 96 Red Hawk
                      Road Cyrus, MN 56323{" "}
                    </p>
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom d-flex">
                    <div className="profile-widget w-100">
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product.jpg"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product13.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product12.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product11.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product3.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product10.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product4.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product14.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product5.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product6.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product15.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product7.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                      ...
                      <div className="doc-img">
                        <a href="product-description" tabindex="-1">
                          <img
                            className="img-fluid"
                            alt="Product image"
                            src="/component_assets/img/products/product8.jpg"
                          />
                        </a>
                        <a
                          href="javascript:void(0)"
                ...
                <div className="col-md-12 text-center">
                  <a href="#" className="btn book-btn1 mb-4">
                    Load More
                  </a>
                </div>
              </div>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="2a4e4549495f584f6a4f524b475a464f04494547"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
