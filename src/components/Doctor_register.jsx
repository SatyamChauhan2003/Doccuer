                  ...
                  <div className="account-content">
                    <div className="row align-items-center justify-content-center">
                      <div className="col-md-7 col-lg-6 login-left">
                        <img
                          src="/component_assets/img/login-banner.png"
                          className="img-fluid"
                          alt="Login Banner"
                        />
                      </div>
                      <div className="col-md-12 col-lg-6 login-right">
                        <div className="login-header">
                          <h3>
                            Doctor Register{" "}
                            <a href="register">Not a Doctor?</a>
                          </h3>
                        </div>

                        <form action="https://doccure.dreamguystech.com/html/template/doctor-register-step1">
