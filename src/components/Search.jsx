            ...
            <div className="row">
              ...
              <div className="col-md-12 col-lg-8 col-xl-9">
                    ...
                    <div className="doctor-widget">
                      ...
                      <div className="doc-info-right">
                        ...
                        <div className="clinic-booking">
                          <a className="view-pro-btn" href="doctor-profile">
                            View Profile
                          </a>
                      ...
                      <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                          ...
                          <p className="doc-department">
                            <img
                              src="/component_assets/img/specialities/specialities-04.png"
                              className="img-fluid"
                              alt="Speciality"
                            />
                            Cardiology
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                          ...
                          <p className="doc-department">
                            <img
                              src="/component_assets/img/specialities/specialities-01.png"
                              className="img-fluid"
                              alt="Speciality"
                            />
                            Urology
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                          ...
                          <p className="doc-department">
                            <img
                              src="/component_assets/img/specialities/specialities-03.png"
                              className="img-fluid"
                              alt="Speciality"
                            />
                            Orthopaedics
                ...
                <div className="load-more text-center">
                  <a
                    className="btn btn-primary btn-sm prime-btn"
                    href="javascript:void(0);"
                  >
                    Load More
                  </a>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="10747f7373656275507568717d607c753e737f7d"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
