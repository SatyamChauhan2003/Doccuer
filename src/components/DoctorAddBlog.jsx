                    ...
                    <div className="col">
                      <ul className="nav nav-tabs nav-tabs-solid">
                        <li className="nav-item">
                          <a className="nav-link" href="doctor-blog">
                            Acitive Blog
                          </a>
                        </li>
                        <li className="nav-item">
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <form
                        ...
                        autocomplete="off"
                        id="update_service"
                        action="https://doccure.dreamguystech.com/html/template/doctor-blog"
                      >
                        <input
                          type="hidden"
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="f99d969a9a8c8b9cb99c81989489959cd79a9694"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
