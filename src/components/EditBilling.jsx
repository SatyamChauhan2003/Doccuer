  ...
  return (
    <div>
      <div className="main-wrapper">
        ...
        <div className="content edit-billing-content">
          <div className="container">
            <div className="row">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="add-more-item text-end">
                      <a href="javascript:void(0);" className="add-items">
                          ...
                          <table className="table table-hover table-center add-table-items">
                            <thead>
                              <tr>
                                <th>Title</th>
                                <th>Amount</th>
                                <th className="custom-className"></th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr className="test">
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="91f5fef2f2e4e3f4d1f4e9f0fce1fdf4bff2fefc"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
