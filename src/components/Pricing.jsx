                  ...
                  <div className="card-body">
                    <div className="pricing-header">
                      <div className="pricing-header-info">
                        <div className="pricing-icon">
                          <span>
                            <img
                              src="/component_assets/img/icons/price-icon1.svg"
                              alt="icon"
                            />
                          </span>
                        </div>
                    ...
                    <div className="pricing-info">
                      ...
                      <div className="pricing-btn">
                        <a href="login-email" className="btn btn-primary">
                          Get Started
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="pricing-header">
                      <div className="pricing-header-info">
                        <div className="pricing-icon">
                          <span>
                            <img
                              src="/component_assets/img/icons/price-icon2.svg"
                              alt="icon"
                            />
                          </span>
                        </div>
                    ...
                    <div className="pricing-header">
                      <div className="pricing-header-info">
                        <div className="pricing-icon">
                          <span>
                            <img
                              src="/component_assets/img/icons/price-icon3.svg"
                              alt="icon"
                            />
                          </span>
                        </div>
                          ...
                          <div className="footer-address mb-0">
                            <p>
                              ...
                              <a
                                ...
                                data-cfemail="583c373b3b2d2a3d183d20393528343d763b3735"
                              >
                                [email&#160;protected]
                              </a>
                            </p>
