              ...
              <div className="card-body">
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <p className="card-text">
                      Use <code>.btn-outline-*</code> className for outline buttons.
                    </p>
                  </div>
                  <div className="card-body">
                    ...
                    <div className="row row-sm align-items-center mt-3">
                      ...
                      <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                          type="button"
                          className="btn w-100 btn-outline-info active"
                        >
                          Info
                        </button>
                      </div>
                      ...
                      <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                          type="button"
                          className="btn w-100 btn-outline-dark active"
                        >
                          Dark
                        </button>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-12 col-md-6 col-lg-4 d-flex">
                      <div className="card flex-fill">
                        <img
                          alt="Card Image"
                          src="/component_assets/img/img-01.jpg"
                ...
                <section className="comp-section">
                  <div className="comp-header">
                    <h3 className="comp-title">Modals</h3>
                    <div className="line"></div>
                  </div>
                  <div className="card">
                    <div className="card-header">
                    ...
                    <div className="card-body">
                      <p>
                        ...
                        and display have been overridden). Included are the
                        modal header, modal body (required for padding), and
                        modal footer (optional). We ask that you include modal
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <button
                        className="btn btn-primary custom-components"
                        type="button"
                            ...
                            <div className="footer-address mb-0">
                              <p>
                                ...
                                <a
                                  ...
                                  data-cfemail="60040f0303151205200518010d100c054e030f0d"
                                >
                                  [email&#160;protected]
                                </a>
                              </p>
