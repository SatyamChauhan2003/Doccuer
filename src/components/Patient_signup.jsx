                ...
                <div className="account-content">
                  <div className="login-shapes">
                    <div className="shape-img-left">
                      <img
                        src="/component_assets/img/shape-01.png"
                        alt="shape-image"
                      />
                    </div>
                    <div className="shape-img-right">
                      <img
                        src="/component_assets/img/shape-02.png"
                        alt="shape-image"
                      />
                    </div>
                  </div>
                  <div className="account-info">
                    ...
                    <form action="https://doccure.dreamguystech.com/html/template/signup-success">
                      <div className="mb-3">
                      ...
                      <div className="mb-3 back-btn-light">
